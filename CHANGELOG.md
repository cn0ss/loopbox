...
### Added
- Agent API audit tab (Pro/Ultimate) to inspect local Agent API request/response records, including headers, body snapshots, status, and latency.
...
- Agent API audit implementation ownership was moved to the private EE crate; public core keeps bridge/stub wiring only.
...
- Clarified public/private edition boundaries and moved EE integration behind private crate adapters.
- Refreshed docs/UI copy around paid feature boundaries.

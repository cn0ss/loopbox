...
- **Terminal Integration** — one click opens macOS Terminal with working directory and merged env
...
**Prerequisites:** macOS, [Rust toolchain](https://rustup.rs/), [Dioxus CLI](https://dioxuslabs.com/learn/0.7/getting_started)
...
Loopbox is licensed under the [PolyForm Noncommercial License 1.0.0](LICENSE). Free for personal use. Commercial use requires a [paid license](https://loopbox.tech/pricing).
